...
const ALLOWED_PREFIXES = ['logo_', 'footer_', 'site_name', 'site_whatsapp', 'site_description', 'favicon_url', 'hero_slides', 'color_', 'hide_prices', 'home_carousel_auto', 'home_categories', 'home_carousel_categories', 'home_brands', 'home_sections', 'menu_categories', 'hamburger_categories'];
